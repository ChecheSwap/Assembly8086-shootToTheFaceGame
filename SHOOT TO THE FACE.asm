;NOTES: #IF YOU RECIBED <DIRECTORY ALREADY EXIST> IT IS NORMAL DO NOT WORRY, #FILE OPERATION: ALL SCORES WITH THE LAST NAME IN THE FIRST AREA OF A VECTOR INITIALIZER
;@CHECHESWAP
